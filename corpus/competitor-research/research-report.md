...
> Generated from `corpus/competitor-research/corpus.json` by `npm run research -- report` on 2026-06-10. Do not hand-edit.

## Corpus overview

- Items: **22** (scored 22, unscored 0)
- MVP-candidate insights (opportunity_score ≥ 32): **8**
- Average opportunity score: **29.3 / 40**

- By source type: manual_note 13 · product_page 6 · help_doc 2 · pricing_page 1
- By sentiment: neutral 9 · positive 8 · negative 5
- By category: stats 8 · lineup 6 · scorekeeping 5 · hardware_metrics 4 · training 4 · recruiting 3 · team_management 3 · video_analysis 2 · club_ops 1 · practice_planning 1
...
| Tag | Count |
| --- | --- |
| Data locked in platform | 5 |
| Training plan too generic | 5 |
| Subscription frustration | 4 |
| Hardware too expensive | 3 |
| Coach/admin workload too high | 3 |
| No player-owned history | 3 |
| No arm-care guardrails | 2 |
| No defensive fairness tracking | 2 |
| Bad UX | 1 |
| App crashes / freezes | 1 |
| Scorekeeping mistakes are hard to fix | 1 |
| No age scaling | 1 |
...
| Multi-game tournament planner | 2 |
| Parent progress report | 2 |
| Pitcher/catcher restriction assistant | 2 |
| Player homework | 2 |
...
| Tag | Count |
| --- | --- |
| Track player progress | 9 |
| Create a fair lineup | 5 |
| Build a player profile | 4 |
| Capture objective measurables | 4 |
| Assign training homework | 3 |
| Track pitch count | 3 |
| Balance infield/outfield reps | 2 |
| Manage pitcher/catcher restrictions | 2 |
| Reduce parent complaints | 2 |
| Score a game | 2 |

## Research backlog

- Platforms catalogued: **38**
  - Wave 1 (Core baseball apps — cleanest signal (target 1,500-2,500 items)): 20
  - Wave 2 (Data, hardware, and player-profile systems (target 1,000-1,500 items)): 13
  - Wave 3 (Team/league/tournament ops (target 750-1,250 items)): 5
